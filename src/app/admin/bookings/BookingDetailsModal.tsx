...
interface BookingDetailsModalProps {
  ...
  onClose: () => void;
  onUpdateStatus: (booking: Record<string, unknown>, status: string) => void | Promise<void>;
}
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">
              Inquiry ID: {String(booking.id).slice(0, 8)}
            </p>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-gray-500">
                Received on{' '}
                {booking.createdAt
                  ? new Date(booking.createdAt as string | number | Date).toLocaleString()
                  : ''}
              </span>
            </div>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-4 space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <a
                  href={`mailto:${String(booking.email || '')}`}
              ...
              {!!booking.preferredDate && (
                <div>
                  ...
                  <div className="font-medium text-gray-900 flex items-center gap-2">
                    ...
                    {new Date(booking.preferredDate as string | number | Date).toLocaleDateString()}
                  </div>
                </div>
              )}
            </div>
          ...
          {!!booking.notes && (
            <div className="bg-yellow-50 rounded-lg p-4 space-y-3">
              ...
              <p className="text-gray-700 whitespace-pre-wrap">{String(booking.notes)}</p>
            </div>
          )}
          ...
          <div className="border-t border-gray-200 pt-6">
            ...
            <div className="flex flex-wrap gap-3">
              <a
                href={`mailto:${String(booking.email || '')}?subject=Re: Medical Tourism Inquiry&body=Dear ${String(booking.firstName || '')} ${String(booking.lastName || '')},%0D%0A%0D%0AThank you for your inquiry about ${String(booking.treatmentType || '')}.%0D%0A%0D%0A`}
