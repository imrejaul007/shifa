...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const title = isArabic
    ? 'الخدمات الطبية للمرضى من السعودية - شفاء الهند'
  ...
  const keywords = [
    ...
    'medical visa Saudi to India',
    'healthcare for Saudi residents',
  ];
  ...
  return generateFullMetadata({
    ...
    canonical: `/${locale}/for-saudi-patients`,
    ogType: 'website',
  });
}

export default async function SaudiPatientsPage({ params }: PageProps) {
  const { locale } = await params;
  const isArabic = locale === 'ar';

  const breadcrumbItems = [
    { name: isArabic ? 'الرئيسية' : 'Home', url: '/' },
    { name: isArabic ? 'لمرضى السعودية' : 'For Saudi Patients', url: '/for-saudi-patients' },
  ];
    ...
    <>
      ...
      <section className="bg-gradient-to-r from-primary to-primary-dark text-white py-20">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            {isArabic
              ? 'مرحباً بمرضى المملكة العربية السعودية'
              : 'Welcome Saudi Patients to World-Class Healthcare in India'}
          </h1>
          <p className="text-xl mb-8">
            {isArabic
              ? 'احصل على رعاية صحية عالمية المستوى في الهند بتكلفة 60-70٪ أقل من السعودية'
              : 'Get world-class healthcare in India at 60-70% lower cost than Saudi Arabia'}
          </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">
            {isArabic
              ? 'لماذا يختار مرضى السعودية الهند للعلاج؟'
              : 'Why Saudi Patients Choose India for Treatment'}
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                {isArabic
                  ? 'وفر 60-70٪ على جميع الإجراءات الطبية مقارنة بأسعار السعودية. جراحة القلب: 10,000 - 15,000 دولار (مقابل 50,000+ دولار في السعودية)'
                  : 'Save 60-70% on all medical procedures compared to Saudi prices. Heart surgery: $10,000-15,000 (vs $50,000+ in Saudi Arabia)'}
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                {isArabic
                  ? 'فقط 4-5 ساعات طيران من جدة أو الرياض إلى بنغالور. رحلات مباشرة على السعودية، فلاي ناس، وإنديجو. لا حاجة لرحلات طويلة مرهقة.'
                  : 'Only 4-5 hours flight from Jeddah or Riyadh to Bangalore. Direct flights on Saudia, Flynas, and IndiGo. No long exhausting journeys required.'}
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                {isArabic
                  ? 'مترجمون سعوديون متاحون 24/7، أطباء يتحدثون العربية، تقارير طبية بالعربية، وطعام حلال. تشعر وكأنك في بيتك.'
                  : 'Saudi translators available 24/7, Arabic-speaking doctors, medical reports in Arabic, and halal food. Feel at home.'}
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                {isArabic
                  ? 'نعمل فقط مع مستشفيات حاصلة على اعتماد JCI و NABH الدولي. نفس معايير الجودة مثل أفضل مستشفيات الرياض وجدة.'
                  : 'We work only with JCI and NABH internationally accredited hospitals. Same quality standards as top Riyadh and Jeddah hospitals.'}
              </p>
            </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">
            {isArabic
              ? 'العلاجات الأكثر شعبية لمرضى السعودية'
              : 'Most Popular Treatments for Saudi Patients'}
          </h2>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">
            {isArabic ? 'خدماتنا لمرضى السعودية' : 'Our Services for Saudi Patients'}
          </h2>
